...
# 変更：dataset_loaderを使用
# 変更：TBPTT_rep_v7を使用（Δposをmmサイズで予測）
...
with open(output_path, "w") as file:
    ...
    file.write("2025/11/28: TBPTTv7 & mask率スケジューリング")
...
trainer = TBPTT_rep_trainer(model, optimizer, loss_weights=loss_weights, joint_dim=args.joint_dim, truncation_length=30, device=device)

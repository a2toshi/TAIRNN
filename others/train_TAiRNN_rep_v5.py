...
from libs.TBPTT_rep_v3 import TBPTT_rep_trainer  # TODO
from ModelCode.data import MultimodalDataset  # TODO
from ModelCode.model import TAiRNNv2  # TODO
...
# データセット
dataset_root_dir = "/work/gn45/n45002/savedata/traindata_20251021/"
...
with open(output_path, "w") as file:
    ...
    file.write("2025/11/08: epoch数↓lr↑")
...
trainer = TBPTT_rep_trainer(model, optimizer, loss_weights=loss_weights, joint_dim=args.joint_dim, device=device)
...
for epoch in pbar_epoch:
    ...
    (
        ...
        train_pt_loss,
        train_rp_loss,
    ) = trainer.process_epoch(train_loader, epoch=epoch, num_epochs=args.epoch)
    with torch.no_grad():
        (
            test_loss,
            test_img_loss,
            ...
            test_pt_loss,
            test_rp_loss,
        ) = trainer.process_epoch(test_loader, epoch=epoch, num_epochs=args.epoch, training=False)

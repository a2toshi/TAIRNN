...
from libs.fullBPTT_repulsion import fullBPTT_rep_trainer  # TODO
from ModelCode.data import MultimodalDataset  # TODO
from ModelCode.model import TAiRNN  # TODO
...
with open(output_path, "w") as file:
    ...
    file.write("2025/10/14: 新規データセットでTAiRNN学習/新規gヘッド追加/widthとheightの取り換え/注意点数↓/temp↑/repLoss↑/PEとLNの位置関係変更/attn_out追加")
...
trainer = fullBPTT_rep_trainer(model, optimizer, loss_weights=loss_weights, device=device)

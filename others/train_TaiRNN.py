...
# from libs.fullBPTT import fullBPTTtrainer  # TODO
from libs.multiStep_fullBPTT import MultiStepfullBPTTtrainer
from ModelCode.data import MultimodalDataset  # TODO
from ModelCode.model import SARNN, TAiRNN  # TODO
...
# データセット
dataset_root_dir = "/work/gn45/n45002/savedata/traindata_20250621_v2/"
...
with open(output_path, "w") as file:
    ...
    file.write("2025/06/30: 新規データセットでSARNN学習")
...
trainer = MultiStepfullBPTTtrainer(model, optimizer, loss_weights=loss_weights, device=device)

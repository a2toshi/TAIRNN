...
from libs.TBPTT_rep_v8 import TBPTT_rep_trainer  # TODO
from ModelCode.data import MultimodalDataset  # TODO
from ModelCode.model import TAiRNNv4  # TODO
...
trainer = TBPTT_rep_trainer(model, optimizer, loss_weights=loss_weights, joint_dim=args.joint_dim, truncation_length=args.chunk_size, device=device)

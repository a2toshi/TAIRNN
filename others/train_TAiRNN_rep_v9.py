...
from libs.TBPTT_rep_v5 import TBPTT_rep_trainer  # TODO
from ModelCode.data import MultimodalDataset  # TODO
from ModelCode.model import TAiRNNv3  # TODO
...
# 変更：dataset_loader_v2を使用
# 変更：TBPTT_rep_v5を使用（Δposをmmサイズで予測）
...
trainer = TBPTT_rep_trainer(model, optimizer, loss_weights=loss_weights, joint_dim=args.joint_dim, truncation_length=50, device=device)
